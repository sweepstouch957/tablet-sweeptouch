...
import { printImageWithRawBT, printTicketWithImage } from "@/libs/utils/printRawBt";
...
const LeftPanel: React.FC<LeftPanelProps> = ({
  ...
  const { mutate: registerParticipant, isPending } = useMutation({
    ...
    `,
      ...
      printTicketWithImage("https://res.cloudinary.com/dg9gzic4s/image/upload/v1751982268/chiquitoy_ioyhpp.jpg",{
